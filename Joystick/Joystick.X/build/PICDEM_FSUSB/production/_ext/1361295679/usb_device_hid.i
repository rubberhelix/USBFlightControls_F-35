...
# 2 "<built-in>" 2
# 1 "../source/usb/usb_device_hid.c" 2
...
# 2 "../source/usb/usb_device_hid.c" 2
...
# 3 "../source/usb/usb_device_hid.c" 2
# 24 "../source/usb/usb_device_hid.c"
typedef struct
{
    unsigned :8;
    unsigned :8;
...
extern const struct{uint8_t report[45];}hid_rpt01;
# 118 "../source/usb/usb_device_hid.c"
void USBCheckHIDRequest(void)
{
    ...
    if(SetupPkt.bRequest == 6)
    {
        switch(SetupPkt.bDescriptorType)
        {
            ...
            case 0x22:
                ...
                {
                    { inPipes[0].pSrc.bRom = (const uint8_t*)&hid_rpt01; inPipes[0].wCount.Val = 45; inPipes[0].info.Val = 0x40 | 0x80 | 0x00; };
                ...
                break;
            case 0x23:
# 162 "../source/usb/usb_device_hid.c"
                break;
        }
    }
