# 1 "../source/app_device_joystick.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../source/app_device_joystick.c" 2




# 1 "../headers/usb\\usb.h" 1
# 17 "../headers/usb\\usb.h"
# 1 "../headers/usb/usb_config.h" 1
...
# 1 "../headers/usb\\usb_ch9.h" 1
# 14 "../headers/usb\\usb_ch9.h"
...
# 14 "../headers/usb\\usb_ch9.h" 2
# 43 "../headers/usb\\usb_ch9.h"
...
# 8 "../headers/usb/usb_config.h" 2
# 17 "../headers/usb\\usb.h" 2


# 1 "../headers/usb/usb_common.h" 1
# 18 "../headers/usb/usb_common.h"
...
# 18 "../headers/usb/usb_common.h" 2

# 1 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\include\\c99\\stdbool.h" 1 3
# 19 "../headers/usb/usb_common.h" 2
# 104 "../headers/usb/usb_common.h"
typedef union
{
    uint8_t bitmap;
    struct
...
# 360 "../headers/usb/usb_common.h"
typedef struct _vbus_power_data
{
    uint8_t port;
    uint8_t current;
} USB_VBUS_POWER_EVENT_DATA;
# 373 "../headers/usb/usb_common.h"
...
# 435 "../headers/usb/usb_common.h"
typedef _Bool (*USB_EVENT_HANDLER) ( USB_EVENT event, void *data, unsigned int size );
# 19 "../headers/usb\\usb.h" 2




# 1 "../headers/usb/usb_device.h" 1
# 50 "../headers/usb/usb_device.h"
typedef enum
{
...
# 1 "../headers/usb/usb_hal.h" 1
# 15 "../headers/usb/usb_hal.h"
# 1 "../headers/usb/usb_hal_pic18.h" 1
# 12 "../headers/usb/usb_hal_pic18.h"
...
# 12 "../headers/usb/usb_hal_pic18.h" 2
# 27 "../headers/usb/usb_hal_pic18.h"
...
# 27 "../headers/usb/usb_hal_pic18.h" 2
# 247 "../headers/usb/usb_hal_pic18.h"
...
# 587 "../headers/usb/usb_hal_pic18.h"
    extern uint8_t USBActiveConfiguration;
...
# 6 "../source/app_device_joystick.c" 2
...
# 58 "../headers\\buttons.h"
_Bool BUTTON_IsPressed(BUTTON button);
# 76 "../headers\\buttons.h"
...
# 8 "../source/app_device_joystick.c" 2
# 25 "../source/app_device_joystick.c"
...
# 70 "../source/app_device_joystick.c"
        struct
        {
            uint8_t X;
            uint8_t Y;
...
# 95 "../source/app_device_joystick.c"
        INPUT_CONTROLS joystick_input __attribute__((address(0x500)));
...
# 117 "../source/app_device_joystick.c"
...
# 141 "../source/app_device_joystick.c"
void APP_DeviceJoystickTasks(void)
{
    ...
    if(!((lastTransmission != 0x0000) && ((*(volatile uint8_t*)lastTransmission & 0x80) != 0x00)))
    {
        ...
        joystick_input.members.buttons.s2_1 = (ADC_multiButton(ADC_CHANNEL_2) == 1) ? 1 : 0;
        joystick_input.members.buttons.s2_2 = (ADC_multiButton(ADC_CHANNEL_2) == 2) ? 1 : 0;
        joystick_input.members.buttons.s2_3 = (ADC_multiButton(ADC_CHANNEL_2) == 3) ? 1 : 0;
        joystick_input.members.buttons.s2_4 = (ADC_multiButton(ADC_CHANNEL_2) == 4) ? 1 : 0;
        joystick_input.members.buttons.s3_1 = (ADC_multiButton(ADC_CHANNEL_3) == 1) ? 1 : 0;
        joystick_input.members.buttons.s3_2 = (ADC_multiButton(ADC_CHANNEL_3) == 2) ? 1 : 0;
        joystick_input.members.buttons.s3_3 = (ADC_multiButton(ADC_CHANNEL_3) == 3) ? 1 : 0;
        joystick_input.members.buttons.s3_4 = (ADC_multiButton(ADC_CHANNEL_3) == 4) ? 1 : 0;
        joystick_input.members.buttons.s3_5 = (ADC_multiButton(ADC_CHANNEL_3) == 5) ? 1 : 0;
        joystick_input.members.buttons.s4_1 = (ADC_multiButton(ADC_CHANNEL_4) == 1) ? 1 : 0;
        joystick_input.members.buttons.s4_2 = (ADC_multiButton(ADC_CHANNEL_4) == 2) ? 1 : 0;
        joystick_input.members.buttons.s4_3 = (ADC_multiButton(ADC_CHANNEL_4) == 3) ? 1 : 0;
        joystick_input.members.buttons.s4_4 = (ADC_multiButton(ADC_CHANNEL_4) == 4) ? 1 : 0;
        joystick_input.members.buttons.s6_1 = (ADC_multiButton(ADC_CHANNEL_5) == 1) ? 1 : 0;
        joystick_input.members.buttons.s6_2 = (ADC_multiButton(ADC_CHANNEL_5) == 2) ? 1 : 0;
        joystick_input.members.buttons.s6_3 = (ADC_multiButton(ADC_CHANNEL_5) == 3) ? 1 : 0;
        joystick_input.members.buttons.s6_4 = (ADC_multiButton(ADC_CHANNEL_5) == 4) ? 1 : 0;
        joystick_input.members.buttons.s8_1 = (ADC_multiButton(ADC_CHANNEL_6) == 1) ? 1 : 0;
        joystick_input.members.buttons.s8_2 = (ADC_multiButton(ADC_CHANNEL_6) == 2) ? 1 : 0;
        joystick_input.members.buttons.s8_3 = (ADC_multiButton(ADC_CHANNEL_6) == 3) ? 1 : 0;
        joystick_input.members.buttons.s8_4 = (ADC_multiButton(ADC_CHANNEL_6) == 4) ? 1 : 0;
        joystick_input.members.buttons.s8_5 = (ADC_multiButton(ADC_CHANNEL_6) == 5) ? 1 : 0;
...
# 207 "../source/app_device_joystick.c"
        joystick_input.members.analog_stick.X = ADC_Readbits(ADC_CHANNEL_0)/4;
        joystick_input.members.analog_stick.Y = ADC_Readbits(ADC_CHANNEL_1)/4;
