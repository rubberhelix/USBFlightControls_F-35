# 1 "../source/usb/usb_descriptors.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../source/usb/usb_descriptors.c" 2
# 122 "../source/usb/usb_descriptors.c"
...
# 122 "../source/usb/usb_descriptors.c" 2
...
# 123 "../source/usb/usb_descriptors.c" 2
...
const struct{uint8_t report[25];}hid_rpt01={{
  0x05,0x01,
  0x09,0x05,
  0xA1,0x01,
  0x26,0xFF,0x00,
