...
# 7 "../source/usb/usb_device.c" 2


# 1 "../headers/usb\\usb.h" 1
# 19 "../headers/usb\\usb.h"
...
# 10 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\include\\c99\\limits.h" 3
...
# 9 "../source/usb/usb_device.c" 2



# 1 "../headers/usb\\usb_device_local.h" 1
# 14 "../headers/usb\\usb_device_local.h"
typedef union
{
    struct
    {
...
# 12 "../source/usb/usb_device.c" 2
# 65 "../source/usb/usb_device.c"
...
# 437 "../source/usb/usb_device.c"
void USBDeviceTasks(void)
{
    uint8_t i;
# 465 "../source/usb/usb_device.c"
    if (1 != 1)
    {
         ...
         USBDeviceState = DETACHED_STATE;
# 502 "../source/usb/usb_device.c"
         {PIR2bits.USBIF = 0;};
         return;
    }
# 526 "../source/usb/usb_device.c"
...
static void USBConfigureEndpoint(uint8_t EPNum, uint8_t direction)
{
    ...
    else
    {
        ...
        handle->STAT.DTS = 0;
        (handle+1)->STAT.DTS = 1;
# 1545 "../source/usb/usb_device.c"
}
# 1576 "../source/usb/usb_device.c"
static void USBCtrlEPServiceComplete(void)
{
...
# 1645 "../source/usb/usb_device.c"
   if(USBDeferINDataStagePackets == 0)
            {
                USBCtrlEPAllowDataStage();
   }
# 1670 "../source/usb/usb_device.c"
            USBStatusStageEnabledFlag2 = 0;
            USBStatusStageEnabledFlag1 = 0;
...
# 2165 "../source/usb/usb_device.c"
static void USBStallHandler(void)
{
# 2177 "../source/usb/usb_device.c"
...
# 2208 "../source/usb/usb_device.c"
static void USBSuspend(void)
{
# 2233 "../source/usb/usb_device.c"
    UIEbits.ACTVIE = 1;
    (UIR &= 0xEF);
...
# 2477 "../source/usb/usb_device.c"
    USBCtrlEPServiceComplete();
}
# 2501 "../source/usb/usb_device.c"
static void USBCtrlTrfOutHandler(void)
{
    if(controlTransferState == 2)
    {
...
# 3033 "../source/usb/usb_device.c"
uint32_t USBGet1msTickCount(void)
{
# 3049 "../source/usb/usb_device.c"
