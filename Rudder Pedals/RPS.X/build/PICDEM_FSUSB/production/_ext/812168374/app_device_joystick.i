...
# 33 "../headers\\buttons.h"
_Bool BUTTON_IsPressed(BUTTON button);
# 51 "../headers\\buttons.h"
...
typedef union _INPUT_CONTROLS_TYPEDEF
{
    struct
    {
# 55 "../source/app_device_joystick.c"
        struct
        {
...
# 102 "../source/app_device_joystick.c"
...
# 126 "../source/app_device_joystick.c"
void APP_DeviceJoystickTasks(void)
{
    ...
    {
# 178 "../source/app_device_joystick.c"
        joystick_input.members.analog_stick.Z = ADC_Readbits(ADC_CHANNEL_0)/4;
        joystick_input.members.analog_stick.Rx = ADC_Readbits(ADC_CHANNEL_1)/4;
        joystick_input.members.analog_stick.Rz = ADC_Readbits(ADC_CHANNEL_2)/4;
