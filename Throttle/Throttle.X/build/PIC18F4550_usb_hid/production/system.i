...
void SYSTEM_Initialize( SYSTEM_STATE state )
{
    switch(state)
    {
        case SYSTEM_STATE_USB_START:
            ...
            BUTTON_Enable(BUTTON_T1);
            BUTTON_Enable(BUTTON_T3);
            BUTTON_Enable(BUTTON_T4_1);
            BUTTON_Enable(BUTTON_T4_2);
            BUTTON_Enable(BUTTON_T5_1);
            BUTTON_Enable(BUTTON_T5_2);
            BUTTON_Enable(BUTTON_T5_3);
            BUTTON_Enable(BUTTON_T6);

            BUTTON_Enable(BUTTON_T9_1);
            BUTTON_Enable(BUTTON_T9_2);
            BUTTON_Enable(BUTTON_T9_3);
            BUTTON_Enable(BUTTON_T10);
            BUTTON_Enable(BUTTON_T11_1);

            BUTTON_Enable(BUTTON_T11_3);
            BUTTON_Enable(BUTTON_T12);
