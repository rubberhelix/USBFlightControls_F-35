...
# 57 "../headers\\buttons.h"
_Bool BUTTON_IsPressed(BUTTON button);
# 75 "../headers\\buttons.h"
...
# 23 "../source/app_device_joystick.c"
...
# 81 "../source/app_device_joystick.c"
...
# 103 "../source/app_device_joystick.c"
...
# 127 "../source/app_device_joystick.c"
void APP_DeviceJoystickTasks(void)
{
    ...
    if(!((lastTransmission != 0x0000) && ((*(volatile uint8_t*)lastTransmission & 0x80) != 0x00)))
    {
        ...
        joystick_input.members.buttons.t2_1 = (ADC_multiButton(ADC_CHANNEL_7) == 1) ? 1 : 0;
        joystick_input.members.buttons.t2_2 = (ADC_multiButton(ADC_CHANNEL_7) == 2) ? 1 : 0;
        joystick_input.members.buttons.t2_3 = (ADC_multiButton(ADC_CHANNEL_7) == 3) ? 1 : 0;
        joystick_input.members.buttons.t2_4 = (ADC_multiButton(ADC_CHANNEL_7) == 4) ? 1 : 0;
        joystick_input.members.buttons.t2_5 = (ADC_multiButton(ADC_CHANNEL_7) == 5) ? 1 : 0;
        joystick_input.members.buttons.t7_1 = (ADC_multiButton(ADC_CHANNEL_3) == 1) ? 1 : 0;
        joystick_input.members.buttons.t7_2 = (ADC_multiButton(ADC_CHANNEL_3) == 2) ? 1 : 0;
        joystick_input.members.buttons.t7_3 = (ADC_multiButton(ADC_CHANNEL_3) == 3) ? 1 : 0;
        joystick_input.members.buttons.t7_4 = (ADC_multiButton(ADC_CHANNEL_3) == 4) ? 1 : 0;
        joystick_input.members.buttons.t7_5 = (ADC_multiButton(ADC_CHANNEL_3) == 5) ? 1 : 0;
        ...
        joystick_input.members.buttons.t11_3 = BUTTON_IsPressed(BUTTON_T11_3);
