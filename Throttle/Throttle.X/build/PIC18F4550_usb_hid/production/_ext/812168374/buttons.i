...
_Bool BUTTON_IsPressed(BUTTON button)
{
    switch(button)
    {
        ...
        case BUTTON_T3:
            return ( (PORTAbits.RA4 == 0) ? 1 : 0);

        case BUTTON_T4_1:
            return ( (PORTCbits.RC7 == 0) ? 1 : 0);

        case BUTTON_T4_2:
            return ( (PORTDbits.RD4 == 0) ? 1 : 0);

        case BUTTON_T5_1:
            return ( (PORTDbits.RD5 == 0) ? 1 : 0);
        ...
        case BUTTON_T9_1:
            return ( (PORTDbits.RD0 == 0) ? 1 : 0);

        case BUTTON_T9_2:
            return ( (PORTDbits.RD1 == 0) ? 1 : 0);

        case BUTTON_T9_3:
            return ( (PORTDbits.RD2 == 0) ? 1 : 0);

        case BUTTON_T10:
            return ( (PORTBbits.RB0 == 0) ? 1 : 0);

        case BUTTON_T11_1:
            return ( (PORTBbits.RB1 == 0) ? 1 : 0);

        case BUTTON_T11_2:
            return ( (PORTBbits.RB1 == 1 && PORTCbits.RC0 == 1) ? 1 : 0);
